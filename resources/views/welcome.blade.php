...
<head>
	...
	<title>schools competitions</title>
	<meta name="description" content="">
	<meta name="viewport" content="{{asset('assets/width=device-width, initial-scale=1')}}">
														...
														<div class="tg-cartcontent dropdown-menu" aria-labelledby="tg-cartdropdown">
															<ul>
																...
																<li>
																	<figure>
																		<a href="#">
																			<img src="{{asset('assets/images/thumbnails/img-02.jpg')}}" alt="image description">
																		</a>
																	</figure>
																	<div class="tg-product-detail">
																		<h3><a href="#">Smooth 3-Stripes Scarf</a></h3>
																...
																<li>
																	<figure>
																		<a href="#">
																			<img src="{{asset('assets/images/thumbnails/img-03.jpg')}}" alt="image description">
																		</a>
																	</figure>
																	<div class="tg-product-detail">
																		<h3><a href="#">Smooth 3-Stripes Scarf</a></h3>
						...
						<nav id="tg-nav" class="tg-nav brand-center">
							<div class="navbar-header">
								...
								<strong class="tg-logo">
									<a href="index-2.html"><img src="{{asset('assets/images/logo.png')}}" alt="image description"></a>
								</strong>
							</div>
						...
						<div class="row">
							<div class="tg-pointstablewrapper">
								...
								<div class="col-sm-4 col-xs-12 hidden-xs">
									<figure>
										<img src="{{asset('assets/images/img-03.png')}}" alt="image description">
									</figure>
								</div>
							</div>
						</div>
									...
									<div class="tg-toprated">
										<ul>
											<li>
												<figure>
													<a href="#">
														<img src="{{asset('assets/images/thumbnails/img-04.jpg')}}" alt="image description">
													</a>
												</figure>
											...
											<li>
												<figure>
													<a href="#">
														<img src="{{asset('assets/images/thumbnails/img-05.jpg')}}" alt="image description">
													</a>
												</figure>
												<div class="tg-productcontent">
													<h4><a href="#">Smooth 3-Stripes Scarf</a></h4><span class="tg-stars"><span></span></span>
											...
											<li>
												<figure>
													<a href="#">
														<img src="{{asset('assets/images/thumbnails/img-06.jpg')}}" alt="image description">
													</a>
												</figure>
												<div class="tg-productcontent">
													<h4><a href="#">Smooth 3-Stripes Scarf</a></h4><span class="tg-stars"><span></span></span>
											...
											<li>
												<figure>
													<a href="#">
														<img src="{{asset('assets/images/thumbnails/img-07.jpg')}}" alt="image description">
													</a>
												</figure>
												<div class="tg-productcontent">
													<h4><a href="#">Smooth 3-Stripes Scarf</a></h4><span class="tg-stars"><span></span></span>
